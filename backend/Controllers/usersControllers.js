...
exports.userpost = async (req, res) => {
    ...
    const { fname, lname, id, email, mobile, gender, location } = req.body;
    ...
    try {
        ...
        if (preuser) {
            ...
            const userData = new users({
                fname, lname, email, mobile, gender, location, profile: file, datecreated
            });
            await userData.save(function (err, result) {
                if (err) {
                    console.log(err);
...
exports.useredit = async (req, res) => {
    const { id } = req.params;
    const { fname, lname, email, mobile, gender, location, user_profile } = req.body;
    ...
    try {
        const updateuser = await users.findByIdAndUpdate({ _id: id }, {
            fname, lname, email, mobile, gender, location, profile: file, dateUpdated
        }, {
            new: true
        });
