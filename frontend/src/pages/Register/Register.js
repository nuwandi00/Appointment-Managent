...
const Register = () => {
  ...
  const submitUserData = async (e) => {
    ...
    if (fname === "") {
      ...
      if (response.status === 200) {
        ...
        window.location.replace("userprofile/" + response.data.id);
  ...
  return (
    <>
      {
        showspin ? <Spiner /> : <div className="container mt-5">
          <h2 className='text-center mt-1'>Make your Appoinment</h2>
          <Card className='shadow mt-5 p-4'>
            ...
            <Form>
              <Row>
                ...
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
                  <Form.Label>Upload a picture of your prefered style</Form.Label>
                ...
                <br /><br />
                <center><button className="btn-submit" type="submit" onClick={submitUserData}>
                  Submit
                </button></center>
              </Row>
